...
Once the `conda-forge` channel has been enabled, `qredis` can be installed with:

```
conda install qredis
```

It is possible to list all of the versions of `qredis` available on your platform with:
